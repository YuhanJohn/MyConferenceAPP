var meal = {
    ...
    deviceready: function () {
		...
		if(forcmeal==1){	
			var MySubmit = "https://docs.google.com/forms/d/"+CheckNfc.substring(3,n)+"/formResponse?entry."+CheckNfc.substring(n+1,h)+"="+GUSID+"&entry.1375730227=2&submit=Submit";	
		$("#formresponse").html(unescape("%3Cscript type='text/javascript' src='" + MySubmit + "'%3E%3C/script%3E"));
		alert("便當領取成功");
		forcmeal++;
		//document.getElementById("mealmybutton").disabled=true;		
		}else {
